...
/* Definition of regular functions, these are missing from the original wcxhead.h 
   at https://github.com/ghisler/WCX-SDK/blob/master/src/wcxhead.h */
/* XXX Not exhaustive, add from https://ghisler.github.io/WCX-SDK/table_of_contents.htm as needed */
HANDLE __stdcall OpenArchive (tOpenArchiveData *ArchiveData);
HANDLE __stdcall OpenArchiveW (tOpenArchiveDataW *ArchiveData);
int __stdcall ReadHeader (HANDLE hArcData, tHeaderData *HeaderData);
/* No ReadHeaderW as per docs, use ReadHeaderExW */
